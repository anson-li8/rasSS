...
vignette: >
 %\VignetteIndexEntry{Pilot Study}
 %\VignetteEngine{knitr::rmarkdown}
 %\VignetteEncoding{UTF-8}
---

*Pilot/tuning run. The main paper-style study is [Paper Replication](03_simulation.html).*
