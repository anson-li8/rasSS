---
title: "Validation (300-SNP toy)"
output: rmarkdown::html_vignette
vignette: >
 %\VignetteIndexEntry{Validation (300-SNP toy)}
 %\VignetteEngine{knitr::rmarkdown}
 %\VignetteEncoding{UTF-8}
---

*Paired-data validation on the 300-SNP toy. The main paper-style study is [Paper Replication](paper-replication.html).*
...
Table: Method comparison -- point estimate (exact binomial 95% CI), single-core sec/rep
