...
*Paired-data validation on the 300-SNP toy. The main paper-style study is [Paper Replication](03_simulation.html).*
...
```{r timing, cache=TRUE, message=FALSE, warning=FALSE, results='hide'}
